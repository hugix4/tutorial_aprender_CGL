...
<link rel="stylesheet" href="../css/b2_07.css">
...
?>
    ...
    <div class="aire"> &nbsp;</div>
      ...
      <h1 class="titulo">¿Cómo buscar información en internet? </h1>

        <div class="col5">
             <center>
             <img src="img/b2_07_01.jpg" style="margin: 5px 0 0 -5px;" />
             </center>
             </div>
  
<div class="col7">
<p>Muchas veces requieres realizar búsquedas de información para alguna tarea o actividad específica de investigación o simplemente para buscar información que necesitas. Por ejemplo: “el origen de los virus informáticos”, “las características de la ciencia”, “la historia de la independencia de los E.U.A.”; son algunos ejemplos de los temas que podrías investigar.</p>
<p>Pareciera que este no es un problema para los jóvenes que viven en la llamada <em>Era de la Información</em>, sin embargo, como dicen por ahí “no todo lo que brilla es oro” y en este caso no todo lo que encontramos en internet, ni en los libros, es información útil. Para ello necesitamos revisar que la información sea confiable y actual.</p>
</div> 

<div class="spacerer" style="margin:0 0 25px 0;">&nbsp;</div> 
<p>Para favorecer las búsquedas de información puedes consultar la siguiente guía:</p>

<a target="_blank" href="docs/busqueda_internet.pdf"><img class="over" style= "margin: 15px -16px -35px 180px;" src="img/b2_07_02.jpg"></a>

<div class="spacerer" style="margin:0 0 25px 0;">&nbsp;</div> 
<!--<p class="resb2">Ahora, realiza el ejercicio 2 con algunas actividades de búsqueda de información.</p>-->
<div class="spacerer" style="margin:0 0 25px 0;">&nbsp;</div> 
<!-- Navegacion --> 
        
    <div class="naveg">
      <div class="ant"> <a href="../bloque2/b2_06.php">anterior</a></div>
      <div class="sig"> <a href="../bloque2/b2_08.php">siguiente</a> </div>
    </div>
