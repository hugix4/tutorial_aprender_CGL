...
?>
    ...
    <div class="spacerer">
      ...
      <p> Con la siguiente actividad    identificarás las estrategias más adecuadas para lograr los objetivos de    aprendizaje que dos profesores te plantean. </p>
    ...
    <div class="col5">
      <p>La profesora de biología te pide<strong> explicar</strong> el fenómeno del amor desde una perspectiva biológica y para ello    te proporciona el siguiente texto  de la Revista ¿Cómo ves?.</p>
      <p>&nbsp;</p>
...
if(isset($_POST["enviar1"])){
		...
		if($enviadas==$esperadas){
			$sql_guardar="INSERT INTO 80Preguntas( p5o1) VALUES( $p1);";
			//echo $sql_guardar;
			$conexion->ejecutar($sql_guardar);
		}
}

$sql_revisar="SELECT COUNT(id_alumno) as 'respuestas' FROM 80Preguntas WHERE id_alumno='$numcta' LIMIT 1;"; 
...
?>
   ...
   <a id="c1"></a>   
    ...
    <!--aquï va la retro del ejercicios, hay que programarla, para que salga cuando damos clic en el botón de comparar respuestas.-->
      ...
      <p>Para alcanzar el objetivo: &ldquo;<span class="resb2meb">Explicar    el fenómeno del amor desde una perspectiva biológica&rdquo; </span>que propuso la    profesora de Biología, hay muchas estrategias de aprendizaje posibles. </p>
   ...
   <p> El profesor de talleres te pide exponer “el impacto del efecto mariposa en nuestra vida cotidiana” para la próxima clase (dentro de 1 día). Te ofrece el siguiente recurso:</p>
...
if(isset($_POST["enviar2"])){
		...
		if($enviadas2==$esperadas2){
			$sql_guardar2="INSERT INTO cuestionario_b2_05_2( id_alumno, tipo_usuario, fecha_hora, p1) VALUES( '$numcta', $tipoUsuario, NOW(), $p2);";
			//echo $sql_guardar;
			$conexion->ejecutar($sql_guardar2);
		}
}

$sql_revisar2="SELECT COUNT(id_alumno) as 'respuestas' FROM cuestionario_b2_05_2 WHERE id_alumno='$numcta' LIMIT 1;"; 
...
<?php if($respuestas2>=1){  ?>
  ...
  <a id="c2"></a>
    ...
    <!--aquï va la retro del ejercicios, hay que programarla, para que salga cuando damos clic en el botón de comparar respuestas.-->
     ...
     <p>Como en el ejemplo anterior no hay una sola estrategia de    aprendizaje posible para alcanzar el objetivo propuesto por el profesor de    talleres: <span class="resb2chi">&ldquo;Exponer el impacto del    efecto mariposa en nuestra vida cotidiana&rdquo;</span></p>
...
<!-- Navegacion --> 
    ...
    <div class="naveg">
      <div class="ant"> <a href="../bloque2/estrategiasAprendizaje">anterior</a></div>
      <div class="sig"> <a href="../bloque2/tecnicasEstudio">siguiente</a> </div>
    </div>
