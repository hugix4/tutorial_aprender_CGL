...
$sql_revisar="SELECT COUNT(id) as 'respuestas' FROM 80Preguntas WHERE id='$numcta' LIMIT 1;"; 
...
if(isset($_POST["enviar2"])){
		...
		if($enviadas2==$esperadas2){
			$sql_guardar2="INSERT INTO 80Preguntas(p5o1) VALUES( $p2);";
			//echo $sql_guardar;
			$conexion->ejecutar($sql_guardar2);
		}
}

$sql_revisar2="SELECT COUNT(id) as 'respuestas' FROM 80Preguntas WHERE id='$numcta' LIMIT 1;"; 
