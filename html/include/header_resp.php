    ...
    <div class="row"> <a href="#" gumby-trigger="#navbar-main-nav #main-nav" class="toggle"></a>
      <nav class="eleven pull_left bloques">
        <ul id="main-nav">
		  ...
		  <?php if(isset($_SESSION["tutorial_cch"])){
					if($_SESSION["tutorial_cch"]==1){
					?>
						<li id="m5" class="diseno"><a href="/salir"><span>Salir</span></a></li>
					<?php
					}
		  } ?>
      ...
      <nav class="three pull_right inicio">
        <ul id="main-nav">
          ...
          <li><a href="/menu" title="Inicio" id="casa"><i class="icon-home" title="Inicio"></i></a></li>
